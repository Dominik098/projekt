...
<body>
        ...
        <nav>
            <ul>
               ...
               <li><a href= "logout">Wyloguj się</a></li>
                <a class="kto-to" > <%=session.getAttribute("email-login") %> </a>
            </ul>
    ...
    <div
        style="background-image: url('zdj1.png'); background-size: cover; background-position: center; height: 450px; opacity: 1;">
    </div>
