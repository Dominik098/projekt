  ...
  <body>
    ...
    <div class="login_form_container">
      <div class="login_form">
		...
		<br> <input placeholder="Imie:" type="text" name="Aimie" required class="input_text"  autocomplete="off"><br>
		...
		<br> <input placeholder="Twoje haslo:" type="password" name="Ahaslo1" required class="input_text" autocomplete="off"><br>
		
       </div> 
       
        <div class="button_group" id="login_button">
         <button><a>Zarejestruj sie</a></button>
        </div>
        
        </form>
        <div class="fotter">
       
          Masz juz konto to:<a href="G_login.jsp">Zaloguj sie</a>
        </div>
